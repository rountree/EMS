...
void trs_init(void* model, trs_t *trs, FILE *fp) {
  ...
  char **trname_3d=NULL;
  char **trname_2d=NULL;
  char **trname_sed=NULL;
  char buf[MAXSTRLEN], key[MAXSTRLEN], tbuf[MAXSTRLEN];
  char* pbuf[MAXSTRLEN];
  char tok[MAXSTRLEN];
  char *args[256];
  char **operation_3d=NULL;
  char **operation_sed=NULL;
  char **operation_2d=NULL;
  char ***tr_3d  = NULL;
  char ***tr_sed = NULL;
  char ***tr_2d = NULL;
  int *om_2d = NULL;
  ...
  int *om_sed = NULL;
  int nargs;
  int *nstatorder3d=NULL;
  int *nstatorder_sed=NULL;
  int *nstatorder2d=NULL;
  int nflux = 0 ;
  int ndomain = 0 ;
  int fluxdir = -1;
